...
<body>
    ...
    <section class="ftco-section ftco-no-pt">
        <div class="container">
            <div class="row">
                <div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url(front/images/about-1.jpg);">
                </div>
    ...
    <section class="ftco-section testimony-section ftco-no-pb">
        <div class="img img-bg border" style="background-image: url(front/images/bg_4.jpg);"></div>
        <div class="overlay"></div>
        <div class="container">
