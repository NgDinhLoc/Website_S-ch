        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item active"><a href="author" class="nav-link">Tác giả</a></li>
                ...
                <div class="col-md-6 col-lg-4 ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch" style="background-image: url(front/images/{{$result->authorImages[0]->path}});"></div>
                        </div>
                        <div class="text pt-3 px-3 pb-4 text-center">
                            <h3>{{$result->Name}}</h3>
                            <div class="faded">
                                <p>{{$result->Description}}</p>
                                <a href="#" class="btn btn-primary">Xem sáng tác</a>
